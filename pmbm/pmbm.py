...
class PMBM:
    ...
    def update_global_hypotheses(self, measurements):
        ...
        if not self.global_hypotheses and self.targets:
            ...
            for global_hypo_id, global_hypo in self.global_hypotheses.items():
                ...
                print("PMBM update_global_hypotheses function: cost_matrix shape is {}, cost_matrix is\n".format(cost_matrix.shape, cost_matrix))
    ...
    def possible_new_targets(self, measurements, classes):
        ...
        print("\nPMBM class possible_new_targets function: measurements number is {}, self.target_counter is {}".format(len(measurements), self.target_counter))
